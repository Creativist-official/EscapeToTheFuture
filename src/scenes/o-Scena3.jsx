...
const Scena3 = () => {
    ...
    return (
        ...
        <div className={"w-full flex flex-col items-center justify-center gap-2 md:gap-10 h-svh gap-auto"}>
            ...
            <ImageMapper
                ...
                onClick={(area) => {
                    if (area.id == "porta_cucina") {
                        // Porta della cucina cliccata, cambia scena
                        setSceneIndex(3);
                        setCurrentDialogueIndex(0);
                        // Reset the hint
                        setHint("");
                    } else if (area.id == "dispensa") {
                        // Dispensa cliccata
                        setDispensaOpen(true);
                    } else if (area.id == "tablet") {
                        // Tablet cliccato, qui parte il mini gioco
            ...
            {/* Cujo */}
            {sceneIndex % 2 == 0 && (<div className="absolute pt-50">
                <ImageMapper
                    src={cujoImg}
                    name="Cane"
                    natural
                    ...
                    <div>
                        {/* Hint */}
                        {
                            hint == "kitchen" && scene == sceneBitritto.scenes[2] && (
                                <div className="absolute left-[16%] top-[40%] z-2 xl:left-95">
